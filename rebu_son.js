...
function setup() {
  ...
  adsr = createSlider(0, 100, 50);
  adsr.position(10, 10);
  
  volume = createSlider(0, 100, 50);
  volume.position(10, 30);
  
  reverbSlider = createSlider(0, 10, 5);
  reverbSlider.position(10, 50);
  
  bpmSlider = createSlider(500, 2000, 1250);
...
function draw(){
  ...
  if(millis() - refTime >=  bpmSlider.value()){
    playSynth();
    refTime = millis();
  }
}
